# LinkedIn DM Variants v2 — Pattern Interrupt + Rotation

**Date:** 2026-06-02
**Replaces:** the straight-pitch opener ("a tool I built…")
**Rules honored:** Yancy's voice · pattern interrupt in line 1 · first line < 200 chars · video mention in every variant · reply-bait CTA (no meeting ask) · no pricing/pilot/sales-process language · "free to use" allowed but never the lead · full message < 300 chars · no banned phrases.

> Usage: type the prospect's first name where you see `[first]`, paste, then attach the product video manually. The rotation tool serves the next variant automatically (see `rotation_schema_handoff.md`).
...
**Pattern interrupt type:** controversy
