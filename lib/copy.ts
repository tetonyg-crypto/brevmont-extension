...
export const copy = {
  ...
  popup: {
    ...
    trialEndedHeading: 'Lead Responder locked',
    trialEndedBody: 'Unlock Lead Responder for $29/mo or $290/year to keep generating.',
    trialEndedCta: 'Unlock Lead Responder',
