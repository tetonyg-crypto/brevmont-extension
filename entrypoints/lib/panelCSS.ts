...
.quick-mode { display:flex; flex-direction:column; flex:1 1 auto; height:100%; max-height:100%; min-height:0; overflow-y:auto; overflow-x:hidden; padding-bottom:var(--panel-safe-bottom); scroll-padding-bottom:var(--panel-safe-bottom); -webkit-overflow-scrolling:touch; overscroll-behavior:contain; scrollbar-gutter:stable; }
...
.input-section { padding:10px 14px; border-bottom:1px solid #e8eaed; flex:0 0 auto; }
...
.first-use-card { position:relative; margin-bottom:8px; padding:9px 32px 9px 10px; border:1px solid rgba(13,110,110,0.18); border-radius:10px; background:#F8F6F1; }
.first-use-card.done { border-color:rgba(22,163,74,0.22); background:#F0FDF4; }
.first-use-eyebrow { font-size:8px; font-weight:800; letter-spacing:1px; text-transform:uppercase; color:#0D6E6E; margin-bottom:2px; }
.first-use-title { font-size:12px; font-weight:750; color:#0F1419; margin-bottom:2px; line-height:1.2; }
.first-use-copy { font-size:10px; line-height:1.35; color:#64748b; }
.first-use-example { margin-top:6px; border:1px solid rgba(13,110,110,0.22); background:#fff; color:#0D6E6E; border-radius:7px; padding:5px 8px; font-size:10px; font-weight:700; font-family:inherit; cursor:pointer; }
...
.overdrive-pill-summary span { overflow:hidden; text-overflow:ellipsis; }
.overdrive-pill-dot-sep { flex:0 0 auto; color:rgba(15,20,25,.35); }
.overdrive-pill-toggle { flex:0 0 auto; border:0; border-radius:6px; background:#F3F4F6; color:#0D6E6E; padding:4px 8px; font-family:inherit; font-size:11px; font-weight:850; cursor:pointer; }
.overdrive-pill-toggle:hover { background:#E6F4F1; }
.overdrive-pill-toggle.is-primary { background:#0D6E6E; color:#fff; }
...
.my-lead-card:hover .lead-card-title::after { content:'View'; display:inline-block; margin-left:6px; font-size:10px; font-weight:700; color:#0D6E6E; letter-spacing:.04em; vertical-align:middle; }
...
.my-lead-card.lost .lead-primary-action, .my-lead-card.lost .appt-inline { display:none !important; }
.my-lead-card.lost .lead-secondary-row { grid-template-columns:1fr; }
.my-lead-card.lost .lead-secondary-row > button:not(.lead-delete-action) { display:none !important; }
...
.lead-secondary-row { display:grid; grid-template-columns:1fr 1fr 1fr 1fr; gap:5px; margin-top:6px; }
...
.lead-delete-action { color:#DC2626; border-color:#FECACA; }
.lead-delete-action:hover { background:#FEF2F2; color:#DC2626; }
...
.outputs { padding:0 14px; overflow:visible; flex:0 0 auto; min-height:0; }
.outputs:not(:empty) { padding:8px 14px var(--panel-safe-bottom); flex:0 0 auto; min-height:auto; }
.out-card { background:#fff; border:1px solid #E5E7EB; border-radius:12px; padding:10px 12px; margin-bottom:8px; scroll-margin-bottom:var(--panel-safe-bottom); }
.out-card-error { border-color:#FECACA; background:#FFF7F7; }
.out-error-copy { border:1px solid #FECACA; border-radius:8px; background:#fff; color:#991B1B; font-size:12px; line-height:1.5; padding:10px; }
...
.tool-content { padding:12px 14px var(--panel-safe-bottom); flex:1 1 auto; min-height:0; overflow-y:auto; display:none; -webkit-overflow-scrolling:touch; overscroll-behavior:contain; scroll-padding-bottom:var(--panel-safe-bottom); }
#o8-tools-panel .tool-content.tool-content-active { display:flex; flex-direction:column; }
#o8-lead-panel { overflow-y:auto; overflow-x:hidden; padding-bottom:var(--panel-safe-bottom); scroll-padding-bottom:var(--panel-safe-bottom); -webkit-overflow-scrolling:touch; overscroll-behavior:contain; scrollbar-gutter:stable; }
#o8-lead-panel > .tool-content { flex:0 0 auto !important; min-height:auto !important; overflow:visible !important; padding:12px 14px 6px; }
...
.settings-account-status { display:flex; align-items:center; gap:6px; margin-top:7px; padding-top:8px; border-top:1px solid #F1F5F9; color:#475569; font-size:11px; font-weight:700; }
#sp-status-dot { width:7px; height:7px; border-radius:999px; background:#94A3B8; box-shadow:0 0 0 3px rgba(148,163,184,.16); }
...
.quick-mode { overflow-y:auto; overflow-x:hidden; padding-bottom:var(--panel-safe-bottom); scroll-padding-bottom:var(--panel-safe-bottom); }
...
.outputs:not(:empty) { padding:6px 12px var(--panel-safe-bottom); flex:0 0 auto; min-height:auto; }
.out-card { padding:8px 10px; margin-bottom:6px; }
.out-label { font-size:9px; margin-bottom:3px; }
.out-textarea { min-height:120px; max-height:min(52vh, 520px); height:auto; font-size:11px; overflow-y:auto; }
.out-actions { gap:5px; margin-top:5px; bottom:calc(var(--account-chip-space) + 8px); }
...
.account-btn:hover::after { box-shadow: 0 0 0 5px rgba(13, 110, 110, 0.12); }
...
.account-btn.overdrive-dot-off::after { background: #CBD5E1; box-shadow: 0 0 0 3px rgba(203, 213, 225, 0.22); }
