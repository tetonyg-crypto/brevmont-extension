...
.quick-mode { display:flex; flex-direction:column; flex:1 1 auto; min-height:0; overflow:hidden; }
...
.outputs:not(:empty) { padding:8px 14px 96px; flex:1 1 auto; min-height:0; }
