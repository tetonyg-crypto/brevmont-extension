...
<div id="o8-tools-panel" class="tools-panel" style="display:none">
  ...
  <div id="tool-command" class="tool-content" style="display:none"><div class="tool-section"><div class="input-wrap"><textarea id="o8-cmd-input" class="main-input" placeholder="e.g., 72 months, 30k car, 2k down, 9%" rows="2"></textarea><button id="o8-cmd-mic" class="inline-mic" title="Tap to dictate"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.5"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/></svg></button></div><div class="ask-chips"><button class="ask-chip">72 months, 30k, 2k down, 9%</button><button class="ask-chip">Next question to ask</button><button class="ask-chip">How to handle a trade</button><button class="ask-chip">Credit concern</button><button class="ask-chip">Set the appointment</button></div><button id="o8-cmd-execute" class="gen-btn">Ask</button></div><div id="o8-cmd-status" class="tool-output"></div></div>
</div>
