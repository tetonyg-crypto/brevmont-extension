...
<div id="o8-quick" class="quick-mode">
  ...
  <div class="input-section">
    ...
    <div class="input-wrap">
      ...
      <button id="o8-input-clear" class="inline-clear" title="Clear direction" type="button" style="display:none"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.5" stroke-linecap="round"><line x1="6" y1="6" x2="18" y2="18"/><line x1="18" y1="6" x2="6" y2="18"/></svg></button>
    </div>
...
<div id="o8-tools-panel" class="tools-panel" style="display:none">
  ...
  <div id="tool-coach" class="tool-content" style="display:none"><div class="tool-section"><div class="input-wrap"><textarea id="o8-coach-input" class="main-input" placeholder="What did the customer just say?" rows="2"></textarea><button id="o8-coach-mic" class="inline-mic" title="Tap to dictate"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.5"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/></svg></button></div><div class="coach-chips"><button class="coach-chip">Need to think about it</button><button class="coach-chip">Price too high</button><button class="coach-chip">Need approval</button><button class="coach-chip">Spouse not here</button><button class="coach-chip">Just looking</button><button class="coach-chip">Timing is not right</button><button class="coach-chip">Found it cheaper</button><button class="coach-chip">Need more information</button></div><button id="o8-coach-btn" class="gen-btn">Coach Me</button></div><div id="o8-coach-output" class="tool-output"></div></div>
  <div id="tool-alerts" class="tool-content" style="display:none"><div class="tool-section"><div class="input-wrap"><input id="o8-alert-input" class="main-input" placeholder="e.g., Call Sally back at 2pm about the follow-up" /><button id="o8-alert-mic" class="inline-mic" title="Tap to dictate"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.5"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/></svg></button></div><button id="o8-alert-btn" class="gen-btn" style="background:#0D6E6E">Set Reminder</button></div><div id="o8-alert-list" class="tool-output"></div></div>
  <div id="tool-command" class="tool-content" style="display:none"><div class="tool-section"><div class="input-wrap"><textarea id="o8-cmd-input" class="main-input" placeholder="Ask about this customer, objection, follow-up, or next step" rows="2"></textarea><button id="o8-cmd-mic" class="inline-mic" title="Tap to dictate"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.5"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="23"/></svg></button></div><div class="ask-chips"><button class="ask-chip">What should I say next?</button><button class="ask-chip">Next question to ask</button><button class="ask-chip">How do I handle this objection?</button><button class="ask-chip">What question should I ask?</button><button class="ask-chip">How should I follow up?</button></div><button id="o8-cmd-execute" class="gen-btn">Ask</button></div><div id="o8-cmd-status" class="tool-output"></div></div>
</div>
...
<div id="o8-lead-panel" class="tools-panel" style="display:none">
  ...
  <div id="lead-scan" class="tool-content" style="display:block"><div class="tool-section"><button id="o8-scan-btn" class="gen-btn">Scan This Page</button><div id="o8-scan-copy" style="font-size:11px;color:#9CA3AF;text-align:center;margin-top:8px">Reads this page and looks for buying intent, fleet requests, customer details, and vehicle interest.</div><div id="o8-scan-empty" style="display:none;font-size:11px;color:#F59E0B;text-align:center;margin-top:8px;padding:8px;background:#FFFBEB;border-radius:6px;">Couldn't read this page. Use the Voice or Paste tab to add this lead.</div></div></div>
...
<div id="o8-review-prompt" class="review-prompt" style="display:none;">
  ...
  <div class="review-title">If this draft was usable, rate Brevmont on the Chrome Web Store.</div>
  <button id="o8-review-link" class="review-link" type="button">Open the Chrome Web Store</button>
</div>
<div id="o8-account-chip" class="account-chip" style="display:none;">
  <div class="account-chip-row">
    <div class="account-chip-text">
      ...
      <div id="o8-account-chip-credit" class="account-chip-credit" style="display:none;"></div>
    </div>
...
`;
  // The panel is shared by all reps. Base markup is already general-sales
  // safe (chip/placeholder copy is industry-neutral); automotive-specific
  // controls are added at render time by removeAutomotivePresetsForGeneralRep
  // for an authenticated, explicitly automotive runtime context.
  return markup;
}
