...
<div id="o8-quick" class="quick-mode">
  ...
  <div class="input-section">
    ...
    <div class="input-wrap">
      ...
      <button id="o8-input-clear" class="inline-clear" title="Clear direction" type="button"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.5" stroke-linecap="round"><line x1="6" y1="6" x2="18" y2="18"/><line x1="18" y1="6" x2="6" y2="18"/></svg></button>
    </div>
